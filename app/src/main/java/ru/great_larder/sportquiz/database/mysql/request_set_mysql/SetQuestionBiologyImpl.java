...
public class SetQuestionBiologyImpl implements SetQuestion {
    @Override
    public Integer setQuestion(User user, Context context, Question question) {
        ...
        try {
            PreparedStatement ps = connectMySQL.connectionMySQL.prepareStatement(biologyMySQL.INSERT(user.getName()), Statement.RETURN_GENERATED_KEYS);
