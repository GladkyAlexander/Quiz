...
public class SetQuestionEtiquetteBusinessImpl implements SetQuestion {
    @Override
    public Integer setQuestion(User user, Context context, Question question) {
        ...
        try {
            PreparedStatement ps = connectMySQL.connectionMySQL.prepareStatement(etiquetteBusinessMySQL.INSERT(user.getName()), Statement.RETURN_GENERATED_KEYS);
