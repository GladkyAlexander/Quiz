...
public class SetQuestionEtiquetteSecularImpl implements SetQuestion {
    @Override
    public Integer setQuestion(User user, Context context, Question question) {
        ...
        try {
            PreparedStatement ps = connectMySQL.connectionMySQL.prepareStatement(etiquetteSecularMySQL.INSERT(user.getName()), Statement.RETURN_GENERATED_KEYS);
