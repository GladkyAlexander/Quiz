...
public class SetQuestionHistoryImpl implements SetQuestion {
    @Override
    public Integer setQuestion(User user, Context context, Question question) {
        ...
        try {
            PreparedStatement ps = connectMySQL.connectionMySQL.prepareStatement(historyMySQL.INSERT(user.getName()), Statement.RETURN_GENERATED_KEYS);
