...
public class SetQuestionMathematicsImpl implements SetQuestion {
    @Override
    public Integer setQuestion(User user, Context context, Question question) {
        ...
        try {
            PreparedStatement ps = connectMySQL.connectionMySQL.prepareStatement(mathematicsMySQL.INSERT(user.getName()), Statement.RETURN_GENERATED_KEYS);
