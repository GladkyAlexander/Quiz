...
public class SetQuestionSportsImpl implements SetQuestion {
    @Override
    public Integer setQuestion(User user, Context context, Question question) {
        ...
        try {
            PreparedStatement ps = connectMySQL.connectionMySQL.prepareStatement(sportsMySQL.INSERT(user.getName()), Statement.RETURN_GENERATED_KEYS);
