...
import ru.great_larder.sportquiz.database.sqlite.sintax_sqlite.BiologySQLite;

public class BiologySQLiteImpl implements BiologySQLite {
    @Override
    public String CREATE(String nameDB) {
        return "CREATE TABLE if not exists biology (id int " +
            ", question text" +
            ", right_answer text" +
            ", wrong_answer_1 text" +
            ", wrong_answer_2 text" +
