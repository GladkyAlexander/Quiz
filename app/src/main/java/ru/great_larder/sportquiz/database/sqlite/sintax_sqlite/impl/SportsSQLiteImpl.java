...
import ru.great_larder.sportquiz.database.sqlite.sintax_sqlite.SportsSQLite;

public class SportsSQLiteImpl implements SportsSQLite {
    @Override
    public String CREATE(String nameDB) {
        return "CREATE TABLE if not exists sports (id int " +
            ", question text" +
            ", right_answer text" +
            ", wrong_answer_1 text" +
            ", wrong_answer_2 text" +
