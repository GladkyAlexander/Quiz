...
public class RoadTransportMySQLImpl implements SyntaxRoadTransport {
	@Override
	public String CREATE(String nameDB) {
		return "CREATE TABLE if not exists`" + nameDB + "`.`road_transport` (id int AUTO_INCREMENT primary key NOT NULL" +
				       ", question text" +
				       ", right_answer text" +
				       ", wrong_answer_1 text" +
				       ", wrong_answer_2 text" +
	...
	public String INSERT(String nameDB) {
		return "INSERT INTO `" + nameDB + "`.`road_transport` ( " +
				       " question," +
				       " right_answer," +
				       " wrong_answer_1," +
				       " wrong_answer_2," +
	...
	public String UPDATE(String nameDB) {
		return "UPDATE `" + nameDB + "`.`road_transport` SET " +
				       " question = ?," +
				       " right_answer = ?," +
				       " wrong_answer_1 = ?," +
				       " wrong_answer_2 = ?," +
	...
	public String SELECT(String nameDB) {
		return "SELECT * FROM `" + nameDB + "`.`road_transport`";
	}
}
