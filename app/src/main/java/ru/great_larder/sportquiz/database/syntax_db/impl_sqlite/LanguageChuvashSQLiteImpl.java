...
public class LanguageChuvashSQLiteImpl implements SyntaxLanguageChuvash {
	@Override
	public String CREATE(String nameDB) {
		return "CREATE TABLE if not exists language_chuvash (id int " +
				       ", question text" +
				       ", right_answer text" +
				       ", wrong_answer_1 text" +
				       ", wrong_answer_2 text" +
	...
	public String SELECT(String nameDB) {
		return "SELECT * FROM language_chuvash";
	}
}
