...
public class LanguageTatarSQLiteImpl implements SyntaxLanguageTatar {
	@Override
	public String CREATE(String nameDB) {
		return "CREATE TABLE if not exists language_tatar (id int " +
				       ", question text" +
				       ", right_answer text" +
				       ", wrong_answer_1 text" +
				       ", wrong_answer_2 text" +
	...
	public String INSERT(String nameDB) {
		return "INSERT INTO language_tatar ( " +
				       " question," +
				       " right_answer," +
				       " wrong_answer_1," +
				       " wrong_answer_2," +
	...
	public String UPDATE(String nameDB) {
		return "UPDATE language_tatar SET " +
				       " question = ?," +
				       " right_answer = ?," +
				       " wrong_answer_1 = ?," +
				       " wrong_answer_2 = ?," +
	...
	public String SELECT(String nameDB) {
		return "SELECT * FROM language_tatar";
	}
}
