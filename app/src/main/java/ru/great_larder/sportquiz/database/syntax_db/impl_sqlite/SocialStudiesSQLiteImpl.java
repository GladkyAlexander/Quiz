...
public class SocialStudiesSQLiteImpl implements SyntaxSocialStudies {
	@Override
	public String CREATE(String nameDB) {
		return "CREATE TABLE if not exists social_studies (id int " +
				       ", question text" +
				       ", right_answer text" +
				       ", wrong_answer_1 text" +
				       ", wrong_answer_2 text" +
	...
	public String INSERT(String nameDB) {
		return "INSERT INTO social_studies ( " +
				       " question," +
				       " right_answer," +
				       " wrong_answer_1," +
				       " wrong_answer_2," +
	...
	public String SELECT(String nameDB) {
		return "SELECT * FROM social_studies";
	}
}
